...
@EndUserText.label: 'T001+TVKO+ADRC'
...
define view entity ZI_CompanyCodeAddress_2
  as select from I_CompanyCode as _CompanyCode //T001
  ...
  association [1..1] to I_SalesOrganization as _SalesOrganization //TVKO
  on  $projection.CompanyCode  = _SalesOrganization.CompanyCode

{
   key _CompanyCode.CompanyCode,
   key _SalesOrganization.SalesOrganization,
